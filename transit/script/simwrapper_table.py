...
def process_mkd_bart(
    ...
    county_br_day.to_csv(os.path.join(BART_output_dir, county_br_day_csv), index=False)
    ...
    county_at_day.to_csv(os.path.join(BART_output_dir, county_at_day_csv), index=False)
